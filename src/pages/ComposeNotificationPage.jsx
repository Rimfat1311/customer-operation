...
export default function ComposeNotificationPage() {
  ...
  const [toastMessage, setToastMessage] = useState(null); // { type, message, title }
  ...
  const compressImage = (file) => {
    return new Promise((resolve) => {
      ...
      reader.onload = (event) => {
        ...
        img.onerror = () => {
          console.warn("Failed to load image for compression, falling back to original");
          resolve(file);
        };
      };
    ...
    try {
      ...
      if (processedFile && mediaType !== 'text') {
        try {
          ...
          console.warn("createBroadcastMedia failed, attempting createBroadcastBase64...", err1);
        ...
        try {
          ...
          console.warn("createBroadcast failed, attempting createBroadcastBase64...", err1);
          await notificationService.createBroadcastBase64(payload);
        }
      }
      ...
      // Reset button checkmark state after 2s
